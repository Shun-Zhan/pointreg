...
with st.sidebar:
    ...
    coarse = st.selectbox("粗配准", ["fpfh", "fpfh_multiscale", "gcransac", "geotransformer", "pca", "none"], format_func={"fpfh":"FPFH + RANSAC", "fpfh_multiscale":"多尺度 FPFH + 几何筛选", "gcransac":"FPFH + GC-RANSAC", "geotransformer":"GeoTransformer (ModelNet)", "pca":"PCA 主轴", "none":"无"}.get, key="coarse")
